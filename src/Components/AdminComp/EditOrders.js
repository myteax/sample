...
const EditOrders = (props) => {
  ...
  return (
    <div>
      {dd.length < 0 && (
        <div className="tr_snie92">
          <img src="/img/Blocks.gif" />
        </div>
      )}
      <div
        className={`container ${dd.length < 0 ? "cxdisabled" : "tr_jfslk233"} `}
      >
        <div className="row">
          <div className="col">
            <div className="tr_djslie2">UPDATE ORDER FORM</div>
          </div>
        </div>
        {resst === 200 ? (
            ...
            <form onSubmit={submitHandler}>
              <div className="form-group">
                <div className="d-lg-flex d-xl-flex tr_divjw3">
                  ...
                  <div className="tr_divsize tr_jwe">
                    <div className="d-flex tr_divsize">
                      ...
                      <input
                        type="text"
                        className="form-control tr_inp323 tr_tway"
                        id="edd"
                        value={edd}
                ...
                <div className="d-flex d-xl-flex justify-content-center justify-content-sm-center justify-content-md-center justify-content-lg-center justify-content-xl-center tr_div_brn">
                  ...
                  <button
                    className="btn btn-success tr_btn423"
                    type="submit"
                    onClick={props.close}
                  >
                    Close
